<div class="login-main-container">
      ...
      <div class="wrapper">
            <div class="xlogo">Oxean <i class="loader_dot">•</i> Gallery</div>
      ...
      <div class="submit-button-container" onclick="Login(document.querySelector('.loginform')), this.classList.toggle('active')">
    ...
    <div class="login-external-container">
      <ul class="login-external list-reset">
        <li class="fb">
          <i>
              <svg width="58" height="58" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
